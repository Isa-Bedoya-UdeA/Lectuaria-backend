...
public interface BookRatingRepository extends JpaRepository<BookRating, Long> {
        ...
        @Query("SELECT br.book.id, br.createdAt FROM BookRating br WHERE br.user.id = :userId")
        List<Object[]> findRatedBooksAndCreatedAtByUserId(@Param("userId") Long userId);
}
