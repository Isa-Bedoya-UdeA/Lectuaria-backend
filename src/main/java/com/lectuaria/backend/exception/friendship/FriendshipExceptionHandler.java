package com.lectuaria.backend.exception.friendship;
...
public class FriendshipExceptionHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FriendshipExceptionHandler.class);

    @ExceptionHandler(ResourceNotFoundException.class)
    public ResponseEntity<ErrorResponseDTO> handleResourceNotFound(ResourceNotFoundException ex, HttpServletRequest request) {
        logger.warn("Friendship resource not found: {}", ex.getMessage());
